...
**Nota:** Apenas o Backend 1 (Supabase) está totalmente funcional e documentado. Os Backends 2 e 3 requerem investigação adicional para determinar suas tecnologias e status operacional.
